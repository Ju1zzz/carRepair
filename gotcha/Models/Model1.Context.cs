...
namespace gotcha.Models
{
    ...
    public partial class GuildsEntities : DbContext
    {
        ...
        public virtual int AutoDraft(Nullable<int> rows)
        {
            var rowsParameter = rows.HasValue ?
                new ObjectParameter("rows", rows) :
                new ObjectParameter("rows", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AutoDraft", rowsParameter);
        }
        ...
        public virtual int AutoProcessing(Nullable<int> rows)
        {
            var rowsParameter = rows.HasValue ?
                new ObjectParameter("rows", rows) :
                new ObjectParameter("rows", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AutoProcessing", rowsParameter);
        }
    
        public virtual int DeleteDraft(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteDraft", idParameter);
        }
        ...
        public virtual int DeleteProcessing(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteProcessing", idParameter);
        }
        ...
        public virtual ObjectResult<string> Request2(Nullable<int> id_g, string letter)
        {
            var id_gParameter = id_g.HasValue ?
                new ObjectParameter("id_g", id_g) :
                new ObjectParameter("id_g", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Request2", id_gParameter, letterParameter);
        }
    
        public virtual ObjectResult<SecondDoc_Result> SecondDoc(Nullable<int> id_g, string letter)
        {
            var id_gParameter = id_g.HasValue ?
                new ObjectParameter("id_g", id_g) :
                new ObjectParameter("id_g", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SecondDoc_Result>("SecondDoc", id_gParameter, letterParameter);
        }
        ...
        public virtual int UpdateDraft(Nullable<int> id, Nullable<int> id_p, Nullable<int> id_m, Nullable<int> v)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateDraft", idParameter, id_pParameter, id_mParameter, vParameter);
        }
        ...
        public virtual int UpdateProcessing(Nullable<int> id, Nullable<int> id_p, Nullable<int> id_m)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateProcessing", idParameter, id_pParameter, id_mParameter);
        }
    }
}
